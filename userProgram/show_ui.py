...
import struct
import global_v 
from user_to_chrome import receive_domain_thread,receive_final_hash_thread;
        ...
        def run_communicate_loop():
            ...
            while True:
                try:
                    ...
                    global_v.random=random_hex;
                    global_v.encrypted=encrypted_hex
...
""")
    ...
    def stop_communication(self):
        if self.timer_trigger==1:
            ...
            global_v.running_trigger=False;
